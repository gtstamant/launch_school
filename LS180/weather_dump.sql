...
--
-- Name: weather; Type: TABLE; Schema: public; Owner: guystamant
--
...
ALTER TABLE public.weather OWNER TO guystamant;

--
-- Data for Name: weather; Type: TABLE DATA; Schema: public; Owner: guystamant
--
