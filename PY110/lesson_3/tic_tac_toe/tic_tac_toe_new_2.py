...
def is_winner(game_state): # demarcate as nested functions - check row, column, diagonal
...
def minimax(game_state):
    ...
    if player == 'X':
        ...
        return min(move_values, key=move_values.get) #add equiv to above if player 'X' but with max
