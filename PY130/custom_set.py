...
class CustomSet:
    def __init__(self, new_elements=None):
        if new_elements:
            self._elements = {element: True for element in new_elements}
        else:
            self._elements = {}
    ...
    def is_subset(self, other):
        return all(element in other._elements for element in self._elements)

    def is_disjoint(self, other):
        return all(element not in other._elements for element in self._elements)
    ...
    def intersection(self, other):
        return CustomSet({element: True for element in self._elements 
